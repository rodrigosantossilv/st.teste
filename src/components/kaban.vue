    ...
    <div class="d-flex">
      ...
      <div class="sidebar bg-secondary text-white p-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <select
              v-model="filterOcupacao"
              class="form-select text-white bg-dark"
              aria-label="Chamados Ti"
              @change="atualizarFiltro"
            >
      ...
      <!-- TABELAS DO KANBAN-->
      <!-- Estrutura repetida para as colunas do Kanban -->
      ...
      <!-- Estruturas semelhantes para outras colunas ("Pendente", "Em Andamento", "Concluído") -->
...
export default {
  ...
  methods: {
    async atualizarFiltro() {
      ...
      // Exibe todos os chamados se a ocupação selecionada for "TODOS"
      this.mostrarTodosChamados = this.filterOcupacao === "TODOS";
    },
    ...
    async carregarChamados() {
      try {
        ...
        // Filtra os chamados de acordo com a ocupação selecionada
        ...
        // Organiza os chamados nas categorias específicas
